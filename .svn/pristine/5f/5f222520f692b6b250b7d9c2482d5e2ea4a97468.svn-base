		...
		<div id="pageWrap">
			<div id="products">
				<table id="tb_main">
					...
					<tr>
						<c:forEach items="${requestScope.bottomProductPage.productList}"
			...
			<div id="page_below">
				<c:forEach begin="${requestScope.bottomProductPage.startPage}"
					end="${requestScope.bottomProductPage.endPage}" var="i">
					<td colspan="3"><a id="pageCount"
						href="./product?type=bottom&page=${i}">${i}</a></td>
				</c:forEach>
			</div>
		</div>
	</section>
