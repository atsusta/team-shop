		...
		<div id="pageWrap">
			<div id="products">
				<table id="tb_main">
					...
					<tr>
						<c:forEach items="${requestScope.topProductPage.productList}"
			...
			<div id="page_below">
				<c:forEach begin="${requestScope.topProductPage.startPage}"
					end="${requestScope.topProductPage.endPage}" var="i">
					<td colspan="3"><a id="pageCount"
						href="./product?type=top&page=${i}">${i}</a></td>
				</c:forEach>
			</div>
		</div>
	</section>
